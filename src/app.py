...
df_Codigos_Muerte = pd.read_excel(r".\data\_Anexo2.CodigosDeMuerte_CE_15-03-23.xlsx",sheet_name="Final")
...
with open(r".\data\Colombia.geo.json", encoding='utf-8') as f:
